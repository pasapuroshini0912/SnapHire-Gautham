...
import { LogOutIcon, LucideMenu, User2, Users } from "lucide-react";
          ...
          <div className="w-full flex items-center justify-between flex-wrap shadow-sm p-2">
            ...
            <div className="flex items-center gap-4">
              <div
                ...
                className="menu md:hidden text-gray-700 hover:text-gray-900"
              >
                <LucideMenu />
              </div>
            </div>
            <div
              className={`${
                menuopen ? "flex border-t border-gray-100 md:border-0" : "hidden md:flex"
              } p-2 rounded md:rounded-none bg-white md:bg-transparent flex-col w-full md:w-auto md:flex-row items-center gap-4 shadow-lg md:shadow-none`}
            >
